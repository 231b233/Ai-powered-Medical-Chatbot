...
# if not GROQ_API_KEY:
#     raise ValueError("GRAQ API KEY is not set in the .env file ")
...
#                {"type": "image_url", "image_url":{"url": f"data:iamge/jpeg;base64,{encoded_image}" }}
#             ]
#          }
#       ]
...
#       llama_11b_response = make_api_request("llama-3.3-70b-versatile")
...
#             logger.info(f"Processes response from {model} API: {answer}")
